-- Seed Data for Community Hubs (UPDATED LIST)
-- Run this in Supabase SQL Editor

INSERT INTO public.community_hubs (name, description, city, whatsapp_announcement_link)
VALUES 
-- GEOGRAPHIC HUBS
('Paris & Proche Banlieue', '75, 92, 93, 94 - City Life 🍸', 'Paris', 'https://chat.whatsapp.com/placeholder_paris'),
('Team Est Francilien', '77, 91 - Nature & Détente 🌿', 'Est', 'https://chat.whatsapp.com/placeholder_est'),
('Team Ouest & Nord', '78, 95 - Chic & Chill 🏰', 'Ouest', 'https://chat.whatsapp.com/placeholder_ouest'),

...
-- BACKFILL: Fix any existing bookings that have a missing partner_id
UPDATE bookings 
SET partner_id = offers.partner_id 
FROM offers 
WHERE bookings.offer_id = offers.id 
  AND bookings.partner_id IS NULL;

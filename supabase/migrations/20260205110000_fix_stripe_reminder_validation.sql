-- Fix check_stripe_connect_status to includes partners that are APPROVED only
-- Before this fix, pending partners were also receiving reminders
...
BEGIN
    ...
    -- 4. Are APPROVED (status = 'approved') - ADDED IN THIS MIGRATION

-- Force replace function to ensure meeting_location is ALWAYS updated from Stripe metadata
...
BEGIN
  ...
  IF v_existing_id IS NOT NULL THEN
     ...
     SET 
        ...
        amount = p_amount,
        variant_id = COALESCE(p_variant_id, variant_id), -- Prefer provided variant
        external_id = p_external_id,
        booking_date = p_booking_date, -- Payment date
        -- CRITICAL FIX: Always prefer the NEW meeting location if provided, effectively overwriting stale data

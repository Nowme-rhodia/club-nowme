...
export function CategoryCard({ category, highlightTerm }: CategoryCardProps) {
  ...
  return (
    <div className="card-border group h-full">
        ...
        <ul className="space-y-2.5 sm:space-y-3.5 flex-grow">
          {category.subcategories.map((subcategory) => (
            <li 
              ...
              className="subcategory-item flex items-center text-gray-600 text-sm transition-all duration-300 ease-in-out hover:text-gray-900 group/item cursor-pointer"
            >

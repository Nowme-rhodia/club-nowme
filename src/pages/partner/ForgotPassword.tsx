...
export default function ForgotPassword() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (partnerError || !partner) {
        setError('Aucun compte partenaire trouvé avec cet email');
        return;
      }
  ...
  return (
    <div className="min-h-screen bg-[#FDF8F4] flex flex-col justify-center py-12 sm:px-6 lg:px-8">
      <SEO 
        title="Mot de passe oublié - Espace partenaire"
        description="Réinitialisez votre mot de passe partenaire Nowme"
      />
          ...
          {success ? (
            <div className="text-center">
              ...
              <p className="text-sm text-gray-500 mb-6">
                Si un compte partenaire existe avec cette adresse email, vous recevrez un lien pour réinitialiser votre mot de passe.
              </p>
              <Link
                to="/partner/signin"
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div>
                <button
                  ...
                  disabled={loading}
                  className={`
                    w-full flex justify-center items-center rounded-full border border-transparent px-4 py-3 text-base font-medium text-white shadow-sm
                    ${loading

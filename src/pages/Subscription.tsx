          ...
          <div className="text-center max-w-4xl mx-auto">
            <motion.div {...fadeInUp}>
              <div className="inline-flex items-center px-4 py-2 bg-primary/10 rounded-full text-primary font-semibold mb-6">
                ...
                <span>Plus de 2000 femmes ont déjà participé à nos événements</span>
              </div>
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                ...
                >
                  ...
                  {isSubscriber ? 'Voir mon compte' : isAuthenticated ? 'Continuer (12,99€ - Places Limitées)' : 'Je commence (Places Limitées)'}
                </Link>
                {!isSubscriber && (
                  <Link
              ...
              <p className="text-sm text-gray-600 mt-4">
                ✨ Annulable à tout moment (mensuel) • Résiliation en 1 clic • Accès complet dès le 1er jour
              </p>
            </motion.div>
          </div>
        </div>
        ...
        <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <motion.div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            >
              ...
              {isSubscriber ? 'Voir mon compte' : isAuthenticated ? 'Continuer vers le paiement (Places Limitées)' : 'Je commence (Places Limitées)'}
